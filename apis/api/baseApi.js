...
export const addRegister = (data) =>
  myRequest.post(`/api/drug-anti-epidemic-drug-sales/add-register`, data, true, {
 ...
 */
export const getCOVID_19DrugTypeList = (data) => myRequest.get(`/dictItems/itemlist-new/dictCode`, data, true, {
  'Authorization': 'Bearer ' + uni.getStorageSync('access_token')
});
 ...
 */
export const getLastRegInfo = (data) => myRequest.get(`/api/drug-anti-epidemic-drug-sales/get-user-newest-register/citizen-user-id`, data, true, {
  'Authorization': 'Bearer ' + uni.getStorageSync('access_token')
});
 ...
 */
export const getRegion = (data) => myRequest.get('/area/getDirectlyLowerRegion', data, true, {
  'Authorization': 'Bearer ' + uni.getStorageSync('access_token')
});
 ...
 */
export const getInfoByEnterprise = (data) => myRequest.get('/api/drug-store/getInfoByEnterpriseId', data, true, {
  'Authorization': 'Bearer ' + uni.getStorageSync('access_token')
});
 ...
 */
export const updateTownship = (data) => myRequest.post('/api/drug-store/updateTownship', data, true, {
  'Authorization': 'Bearer ' + uni.getStorageSync('access_token')
});
 ...
 *
 */
export const getDrugStoreList = (data) => myRequest.get('/api/drug-store/wx/get-page', data);

/**
 * @description 获取首页轮播
 */
export const getBanner = () => myRequest.get('/api/banner/getBannerList');

/**
 * @description 药店获取特色标签字典
 */
export const getDrugFeatureLabel = () =>
  myRequest.get(`/dictItems/itemlistWx/FEATURE_LABEL`, {
...
export const getDrugFeatureService = () =>
  myRequest.get(`/dictItems/itemlistWx/FEATURE_SERVICE`, {
...
export const getDurgHandyService = () =>
  myRequest.get(`/dictItems/itemlistWx/HANDY_SERVICE`, {
...
export const getDrugKnowledgeService = () =>
  myRequest.get(`/dictItems/itemlistWx/DRUG_KNOWLEDGE_SERVICE_TYPE`, {
 ...
 * @description 药品知识的列表
 */
export const getDrugKnowledgeList = (data) => myRequest.get(`/api/drug-knowledge-serve/wx/getWxPage`, data);

/**
 * @description 药品知识的详情
 */
export const getDrugKnowledgeDetail = (data) => myRequest.get(`/api/drug-knowledge-serve/wx/get-by-id-new/id`, data);

/**
 * @description 药品知识阅读量
 */
export const getDrugKnowledgReading = (data) => myRequest.get(`/api/drug-knowledge-serve/wx/increaseRead-new/id`, data);

/**
 * @description 获取个人中心购药记录
 * @param { string } citizenUserId
 */
export const getDrugPurchaseRecord = (citizenUserId) => myRequest.get(`/api/drug-anti-epidemic-drug-sales/get-applet-sales-record-page`, citizenUserId, true,
  {
    'Authorization': 'Bearer ' + uni.getStorageSync('access_token')
  });
 ...
 * @param { string } id
 */
export const getDrugStoreDetails = (id) => myRequest.get(`/api/drug-store/wx/get-info-new/id`, id);
 ...
 *
 */
export const getDrugList = (data) => myRequest.get('/api/drug-medicine/wx/getWxPage', data);

/**
 * @description 获取药品详情
 * @param { stirng } id
 */
export const getDrugDel = (id) => myRequest.get(`/api/drug-medicine/wx/get-by-id-new/id`, id);

/**
 * @description 获取许可证资质信息
 * @param { string } enterpriseId
 */
export const getlicenceMessage = (enterpriseId) => myRequest.get(`/api/certificate-info/getWxList`, enterpriseId);

/**
 * @description 获取药店详情执业药师信息
 * @param { string } enterpriseId
 */
export const getLicensedPharmacist = (enterpriseId) => myRequest.get(`/api/drug-pharmacist/getWxPage`, enterpriseId);
 ...
 * @param { string } enterpriseId
 */
export const getDrugstoreGoods = (data) => myRequest.get(`/api/drug-medicine/wx/getOnSaleMedicineByEnterprise`, data);
/*
 * @description 获取药品关联的在售药店列表
 *
 */
export const getOnsaleDrugstoreList = (data) => myRequest.get('/api/drug-store/wx/get-onsale-page', data);

/**
 * @description 获取热门药品
 *
 */
export const getHotMedicine = () => myRequest.get('/api/drug-medicine/wx/getHotMedicine');

/**
 * @description 获取附近药店信息列表
 *
 */
export const getNearbyDrugstoreList = (data) => myRequest.get('/api/drug-store/wx/get-nearby-page', data);

/**
 * @description 根据药品追溯码查询药品追溯详情
 *
 */
export const getProInfoByDtc = (tcCode) => myRequest.get('/api/ali-review/getInfoByDtc', tcCode);

/**
 * @description 根据商品码以及生产批号查询药品追溯详情
 *
 */
export const getProInfoByCommodityCode = (data) => myRequest.get('/api/ali-review/getProInfoByCommodityCode', data);
...
export const getDrugName = (code) =>
  myRequest.get(
    `/api/drug-medicine/get-by-code-new/code`,
    {
      code
    },
    true, {
...
export const getMultilevelRegion = (proRegionId) =>
  myRequest.get(`/area/areaLevelWx`, {
    proRegionId
  });
...
export const createConsult = (data) =>
  myRequest.post(`/api/drug-consult/add-consult`, data, true, {
    'content-type': 'application/json',
    'Authorization': 'Bearer ' + uni.getStorageSync('access_token')
  });
...
export const getConsultedList = ({ citizenId, pageNum, pageSize }) =>
  myRequest.get(
    `/api/drug-consult/page-new/citizen-id`,
    {
      citizenId,
      pageNum,
      pageSize
...
export const sendMessageOfConsult = (data) =>
  myRequest.post(`/api/drug-leaving-message/add-message`, data, true, {
    'content-type': 'application/json',
    'Authorization': 'Bearer ' + uni.getStorageSync('access_token')
  });
...
export const getChattingRecordsOfCosult = ({ donsultId, pageNum, pageSize }) =>
  myRequest.get(
    `/api/drug-leaving-message/page-new/donsult-id`,
    {
      donsultId,
      pageNum,
      pageSize
...
export const getDonsultDel = (id) =>
  myRequest.get(
    `/api/drug-consult/get-consult-new/id`,
    {
      id
    },
    true, {
...
export const getStorePage = (data) =>
  myRequest.post(
    `/api/drug-stock-info-wx/get-store-page-wx`,
    data,
    true, {
    'content-type': 'application/json',
  }
 ...
 * @description 登录
 */
export const Login = (data) => myRequest.post('/oauth/token', data, true);

/**
 *
 * @description 注册
 */
export const register = (data) => myRequest.post('/api/user/third/register', data, true);

/**
 * @description 解密
 */
export const dc = (data) => myRequest.post('/api/user/third/dc', data, true);
