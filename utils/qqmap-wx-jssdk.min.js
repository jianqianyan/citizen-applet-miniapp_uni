import { promiseGftRequest } from "../common/gftRequest";
var ERROR_CONF = {
  KEY_ERR: 311,
  KEY_ERR_MSG: 'key格式错误',
  PARAM_ERR: 310,
...
class QQMapWX {
  ...
  reverseGeocoder (options) {
    ...
    var locationsuccess = function (result) {
      ...
      promiseGftRequest('txmapapi', requestParam, {
        "content-type": "application/json",
        'Authorization': 'Bearer ' + uni.getStorageSync('access_token')
      }).then(res => {
        if (res.code === 200) {
          Utils.handleData(options, res.data, 'reverseGeocoder')
        }
        else {
          options.fail(res)
        }
